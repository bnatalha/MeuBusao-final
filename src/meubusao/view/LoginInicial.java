...
public class LoginInicial extends javax.swing.JFrame {
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        try{
            if(LoginController.userMatchesPass(jTextFieldUser.getText(), jTextFieldPass.getText())){
                callTelaInicial();
            }
            else{
                JOptionPane.showMessageDialog(this, "senha e usuario nao casam", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        }catch (Exception e){
    ...
    private void jButtonLoginKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButtonLoginKeyPressed
        if(evt.getKeyCode() == evt.VK_ENTER){   // Se pressionar enter, tenta logar
            try{
                if(LoginController.userMatchesPass(jTextFieldUser.getText(), jTextFieldPass.getText())){
                    callTelaInicial();
                }
